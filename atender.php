								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											...
											<li class="active"><a href="atender.php">Chamadas Pendentes </a></li>
											<li><a href="atender2.php">Chamadas Finalizadas </a></li>
		...
		<section class="Feautes section">
			<div class="container">
				<div class="row">
					<div class="col-lg-20">
						<div>
							<h3>Painel de solicitações aos maqueiros - Últimas 10 com status pendente:</h3><br>
									...
									<?php
										while($user_data = mysqli_fetch_assoc($result)){
											...
											echo "<td>
												...
												<a style='color:white;background-color:#094f6e;border-radius: 10px;padding:5px'
												
												href='atenderMaqueiro.php?id=$user_data[id]'> Finalizar </a></td>";
